...
void timer_sleep(int64_t ticks)
{
  ...
  if (ticks > 0)
  {
    ...
    // insert current element in its required position
    list_insert_ordered(&sleep_list, &cur->elem, comparator_sleepticks, NULL);
    thread_sleep(); // block this thread
